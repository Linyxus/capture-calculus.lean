...
def Typed.weaken_var1 (h : Typed (Ctx.extend_var Γ D T0) t C T) P :
  Typed (Ctx.extend_var (Ctx.extend_var Γ E P) D.weaken_var T0.weaken_var) t.weaken_var1 C.weaken_var1 T.weaken_var1 := by
  apply Typed.rename
  exact h
